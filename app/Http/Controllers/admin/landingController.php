...
class landingController extends Controller
{
    public function index()
    {
        ...
        $datas = Landing::where('id_member', session('admin_member_id'))->get();
        return view('admin.landing_page',compact('datas'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($validasi) {
            ...
            if ($request->hasfile('image1')) {
                ...
                $file1->move(public_path() . '/' . session('admin_member_id') . '/photos/', $name1);
                $photo1 = session('admin_member_id') . "/photos/$name1";
            }
            if ($request->hasfile('image2')) {
                ...
                $file2->move(public_path() . '/' . session('admin_member_id') . '/photos/', $name2);
                $photo2 = session('admin_member_id') . "/photos/$name2";
            }
            if ($request->hasfile('image3')) {
                ...
                $file3->move(public_path() . '/' . session('admin_member_id') . '/photos/', $name3);
                $photo3 = session('admin_member_id') . "/photos/$name3";
            }
            if ($request->hasfile('image4')) {
                ...
                $file4->move(public_path() . '/' . session('admin_member_id') . '/photos/', $name4);
                $photo4 = session('admin_member_id') . "/photos/$name4";
            }
            if ($request->hasfile('image5')) {
                ...
                $file5->move(public_path() . '/' . session('admin_member_id') . '/photos/', $name5);
                $photo5 = session('admin_member_id') . "/photos/$name5";
            }
            $hsl = Landing::create([
                'id_member' => session('admin_member_id'),
