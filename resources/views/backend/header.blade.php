        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="/backend/profile" class="dropdown-item has-icon">
                <i class="far fa-user"></i> Profile
              </a>
              <a href="/backend/photo-profile" class="dropdown-item has-icon">
                <i class="far fa-address-card"></i> Upload Foto Profil
              </a>
             
              <div class="dropdown-divider"></div>
              <a href="{{ route('logout_backend') }}" class="dropdown-item has-icon text-danger">
