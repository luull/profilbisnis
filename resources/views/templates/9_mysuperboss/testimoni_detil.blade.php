...
<section class="breadcrumbs">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h2><a href="javascript:history.back(-1)"><i class="fa fa-angle-left"></i></a> Detail Testimoni</h2>
            <ol>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        ...
                        <h2 class="section-title mb-0 " data-aos="fade-left" data-aos-delay="200"><strong>{{$item->judul}}</strong></h2>
                        <hr>
