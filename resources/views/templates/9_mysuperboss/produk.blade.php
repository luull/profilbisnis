                                ...
                                <div class="col-lg-12">
                                    <div class="row justify-content-center">
                                        <div class="col-md-3">
                                            ...
                                            <a href="{{ env('APP_URL') }}/produk1/{{ session('data')->username }}/{{$item->slug}}" class="btn pink-btn2 button btn-rounded">Detail</a>
                                        </div>
                                        <div class="col-md-7">
                                            <a href="https://wa.me/{{ $no_wa }}?text={{ $wa_template1 }} <?PHP echo  str_replace(" ", "%20", $item->nama_brg); ?>" target="_blank" class="btn pink-btn btn-hvr-white button btn-rounded">Beli</a>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row justify-content-center">
                                            <div class="col-md-3">
                                                ...
                                                <a href="{{ env('APP_URL') }}/produk/{{ session('data')->username }}/{{$item->slug}}" class="btn pink-btn2 button btn-rounded">Detail</a>
                                            </div>
                                            <div class="col-md-7">
                                                <a href="https://wa.me/{{ $no_wa }}?text={{ $wa_template1 }} <?PHP echo  str_replace(" ", "%20", $item->nama_brg); ?>" target="_blank" class="btn pink-btn btn-hvr-white button btn-rounded">Beli</a>
